...
```{r violin, fig.height=4.5, fig.width=6.5}
...
```{r GC_combined, fig.height=4.5, fig.width=6.5}
...
```{r lags, fig.height=4, fig.width=6.5}
#plots[[14]] # Lags for both pieces on same graph

CC_combined_lags <- plots[[14]] + facet_wrap(~Piece, labeller = as_labeller(plot_names), strip.position = "top")
CC_combined_lags
